...
export class truongKhoaService {
   ...
   async getAll(): Promise<TruongKhoa[]> {
      return (
         (await this.http
            .get<TruongKhoa[]>(`${this.apiUrl}/api/Truongkhoas`, this.shareService.httpOptions)
            .toPromise()) ?? []
      );
   }
   ...
   async isTruongKhoaByMaGV(MaGV: string): Promise<Boolean> {
      try {
         return (
            (await this.http
               .get<boolean>(
                  `${this.apiUrl}/api/Truongkhoas/isMaGV?isMaGV=${MaGV}`,
                  this.shareService.httpOptions
               )
               .toPromise()) ?? false
         );
   ...
   async add(TruongKhoa: TruongKhoa): Promise<any> {
      return await this.http
         .post(`${this.apiUrl}/api/Truongkhoas`, TruongKhoa, this.shareService.httpOptions)
         .toPromise();
   }
   ...
   async update(TruongKhoa: TruongKhoa): Promise<any> {
      return await this.http
         .put<any>(
            `${this.apiUrl}/api/Truongkhoas/maTK?maTK=${TruongKhoa.maTk}`,
            TruongKhoa,
            this.shareService.httpOptions
         )
         .toPromise();
   ...
   async delete(maTk: number): Promise<any> {
      return await this.http
         .delete(`${this.apiUrl}/api/Truongkhoas/maTK?maTK=${maTk}`, this.shareService.httpOptions)
         .toPromise();
   }
}

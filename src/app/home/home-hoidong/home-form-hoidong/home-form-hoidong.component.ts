...
export class HomeFormHoidongComponent implements OnInit {
   ...
   async ngOnInit(): Promise<void> {
      ...
      if (!this.isAdd) {
         ...
         this.selectedDetaisAPI =
            await this.hoiDongService.ListDeTaiByHoiDongAsync(
               this._hoiDong.maHD
            );
         this.setForm();
      }
      ...
      if (HomeMainComponent.maBm) {
         this.deTais = await this.hoiDongService.ListDetaiPhanBien(
            HomeMainComponent.maBm
         );
   ...
   setForm() {
      ...
      this.form.patchValue({
         ...
         chuTich: this.CTInputConfig.selectedItem,
         thuKy: this.TKInputConfig.selectedItem,
         uyVien: this.UVInputConfig.selectedItem,
         thoiGianBd:
